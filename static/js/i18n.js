...
(function () {
  ...
  var DICT = {
    ...
    "UT": "subs",
    "Keine Tonspur": "No audio track",
    "Keine .nfo im Ordner": "No .nfo in the folder",
    "NFO gefunden, Inhalt konnte nicht gelesen werden.": "NFO found, but the contents could not be read.",
    "extern": "external",
    "NFO / Infos": "NFO / info",
    "Analyse fehlgeschlagen": "Analysis failed",
    "Bibliothek scannen, dann live filtern. Neue Dateien erscheinen erst nach erneutem Scan. Treffer lassen sich mit den aktuellen Encode-Einstellungen in die Warteschlange legen. Über ▸ an der Datei siehst du Tonspuren, Untertitel und – falls vorhanden – die NFO im Ordner.":
      "Scan the library, then filter live. New files appear only after another scan. Matches can be queued with the current encode settings. Use ▸ on a file to see audio tracks, subtitles and – if present – the NFO in the folder.",
  ...
  var DICT_ES = {
    ...
    "UT": "subs",
    "Keine Tonspur": "Sin pista de audio",
    "Keine .nfo im Ordner": "No hay .nfo en la carpeta",
    "NFO gefunden, Inhalt konnte nicht gelesen werden.": "Se encontró un NFO, pero no se pudo leer el contenido.",
    "extern": "externo",
    "NFO / Infos": "NFO / info",
    "Analyse fehlgeschlagen": "Análisis fallido",
    "Bibliothek scannen, dann live filtern. Neue Dateien erscheinen erst nach erneutem Scan. Treffer lassen sich mit den aktuellen Encode-Einstellungen in die Warteschlange legen. Über ▸ an der Datei siehst du Tonspuren, Untertitel und – falls vorhanden – die NFO im Ordner.":
      "Escanea la biblioteca y filtra en vivo. Los archivos nuevos aparecen solo tras otro escaneo. Los resultados se pueden poner en cola con los ajustes de encode actuales. Con ▸ en el archivo ves pistas de audio, subtítulos y – si existe – el NFO de la carpeta.",
  ...
  var DICT_FR = {
    ...
    "UT": "ST",
    "Keine Tonspur": "Aucune piste audio",
    "Keine .nfo im Ordner": "Pas de .nfo dans le dossier",
    "NFO gefunden, Inhalt konnte nicht gelesen werden.": "NFO trouvé, mais le contenu n'a pas pu être lu.",
    "extern": "externe",
    "NFO / Infos": "NFO / infos",
    "Analyse fehlgeschlagen": "Analyse échouée",
    "Bibliothek scannen, dann live filtern. Neue Dateien erscheinen erst nach erneutem Scan. Treffer lassen sich mit den aktuellen Encode-Einstellungen in die Warteschlange legen. Über ▸ an der Datei siehst du Tonspuren, Untertitel und – falls vorhanden – die NFO im Ordner.":
      "Scanne la bibliothèque, puis filtre en direct. Les nouveaux fichiers n'apparaissent qu'après un nouveau scan. Les résultats peuvent être mis en file avec les réglages d'encodage actuels. ▸ sur un fichier affiche les pistes audio, les sous-titres et – s'il existe – le NFO du dossier.",
